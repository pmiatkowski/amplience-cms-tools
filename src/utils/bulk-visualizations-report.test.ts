  ...
  describe('generateBulkVisualizationsReport', () => {
    it('should generate a report header with title and timestamp', () => {
      ...
      const report = generateBulkVisualizationsReport({
        ...
        hubName: 'DEV',
        visualizationConfig: {
          visualizations: [{ label: 'Preview', templatedUri: 'https://vse.dev.com/preview' }],
        },
        isDryRun: false,
      });
    ...
    it('should include operation summary section with hub name and mode', () => {
      ...
      const report = generateBulkVisualizationsReport({
        ...
        hubName: 'PROD',
        visualizationConfig: {
          visualizations: [{ label: 'Preview', templatedUri: 'https://vse.prod.com/preview' }],
        },
        isDryRun: false,
      });
    ...
    it('should include visualization configuration details', () => {
      ...
      const report = generateBulkVisualizationsReport({
        ...
        visualizationConfig: {
          visualizations: [
            {
              label: 'Preview',
              templatedUri: 'https://vse.dev.com/preview?id={{contentItemId}}',
              default: true,
            },
      ...
      expect(report).toContain(
        '- **Preview**: `https://vse.dev.com/preview?id={{contentItemId}}` (default)'
      );
